	...
	n.prototype = {
		...
		checkPage: function() {
			var t = this.opts,
				a = this.total,
				e = this.current;
/*			t.isShow || (this.homePage = this.endPage = ""), 1 === e && (this.homePage = this.prevPage = ""), e === a && (this.endPage = this.nextPage = ""), 1 === a && (this.homePage = this.prevPage = this.endPage = this.nextPage = ""), a <= 0 && (this.isRender = !1)
*/		},
